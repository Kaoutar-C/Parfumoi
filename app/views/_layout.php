...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav_auth">
            <?php if (is_logged()) { ?>
                <a class="btn_connect" href="/checkin/logout">Se déconnecter</a>
            <?php } else { ?>
                <a class="btn_connect" href="/checkin/login">Login</a>
                <a class="btn_connect" href="/checkin/sign">Sign up</a>
            <?php } ?>
        </div>
    </nav>
    ...
    <footer>
        ...
        <div class="footer-copy">
            <p>© 2026 Parfumoi - Tous droits réservés. Mentions légales | Politique de confidentialité | Conditions
                d'utilisation</p>
        </div>
    </footer>
